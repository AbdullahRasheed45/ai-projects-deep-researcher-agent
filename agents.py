...
def run_research(query: str) -> str:
    """Run the deep research process for a given query and return the final report."""
...
if __name__ == "__main__":
    # Example usage
    example_topic = "Extract information about Nebius AI Studio, including its features, capabilities, and applications from available sources."
    result = run_research(example_topic)
    print(result)
